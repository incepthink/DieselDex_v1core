...
pub mod common {
    ...
    use crate::{
        data_structures::{DieselAMMContract, WalletAssetConfiguration},
        interface::{DieselAMM, ValidationHookConfigurables},
    ...
    pub async fn deploy_amm(wallet: &WalletUnlocked) -> DieselAMMContract {
        ...
        let instance = DieselAMM::new(contract_id.clone(), wallet.clone());
